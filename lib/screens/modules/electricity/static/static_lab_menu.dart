...
class _StaticLabMenuState extends State<StaticLabMenu>
  ...
  // ✨ Kartu interaktif (ikon saja yang bergerak)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            // 🌟 Ikon animasi lembut naik-turun dan pulse
            AnimatedBuilder(
              animation: _controller,
              builder: (context, child) {
                final offsetY =
                    sin((_controller.value + delay) * 2 * pi) * 5; // naik-turun
                final scale =
                    1 + sin((_controller.value + delay) * 2 * pi) * 0.05; // pulse
